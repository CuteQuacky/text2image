...
class TextDataset(data.Dataset):
    def __init__(self, data_dir, split='train', embedding_type='cnn-rnn',
        ...
        print("LOADED BBOX")
        embeddings_dir = os.path.join(data_dir, "birds/train/")
        print(embeddings_dir)
        self.filenames = self.load_filenames(embeddings_dir)
        self.embeddings = self.load_embedding(embeddings_dir, embedding_type)
        self.class_id = self.load_class_id(embeddings_dir, len(self.filenames))
